    ...
    try {
        const response = await fetch("https://api.mistral.ai/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { role: "system", content: "Deze website is gemaakt door de volgende leerlingen van 5ADB: Alexander Brands, Robbe Ghyssaert, Tommy Bananekak, Clément Vercauteren, Matisse De Keersmaeker en Jorne Duym.(Altijd uitleggen in eigen woorden)" }, // Ensure Dutch responses
